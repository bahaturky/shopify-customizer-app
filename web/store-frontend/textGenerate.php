...
$font_path = "/var/www/html/all-google-fonts-ttf-only/fonts/$fontName-Regular.ttf";
...
$outline_width = (isset($_GET['outline_width']) ? $_GET['outline_width'] : "1");
...
$cwd = getcwd();
$size = getimagesize("$cwd/$output_file");
$hsjhjsh = filesize("$cwd/$output_file");
// print_r($hsjhjsh);
// die();
